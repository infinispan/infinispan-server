...
public class CustomCacheStoreTest {
    ...
    public static void before() {
        ...
        File[] csClasses = {new File(customLoaderClassesDir + "BrnoCacheStore.class"),
                            new File(customLoaderClassesDir + "BrnoCacheStoreConfiguration.class"),
                            new File(customLoaderClassesDir + "BrnoCacheStoreConfigurationBuilder.class")};
    ...
    public void test() throws Exception {
        ...
        // check via jmx that BrnoCacheStore is indeed used
        ...
        assertEquals("[org.infinispan.persistence.cluster.BrnoCacheStore]", getAttribute(provider, cacheLoaderMBean, "stores"));
    }
