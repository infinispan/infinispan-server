...
public class ExpirationTest {
    ...
    public void testHotRodExpiration() throws Exception {
        ...
        RemoteCache<String, String> c = rcm1.getCache("default");
        RemoteCache<String, String> c2 = rcm2.getCache("default");
