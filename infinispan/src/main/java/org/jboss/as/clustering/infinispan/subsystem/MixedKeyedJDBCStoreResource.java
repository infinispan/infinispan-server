...
public class MixedKeyedJDBCStoreResource extends BaseJDBCStoreResource {
    ...
    protected void registerAddOperation(final ManagementResourceRegistration registration, final OperationStepHandler handler, OperationEntry.Flag... flags) {
        registration.registerOperationHandler(MIXED_KEYED_JDBC_STORE_ADD_DEFINITION.getName(), handler, MIXED_KEYED_JDBC_STORE_ADD_DEFINITION.getDescriptionProvider());
    }
