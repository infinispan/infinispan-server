...
public class InfinispanExtension implements Extension {
    ...
    public void initialize(ExtensionContext context) {
        ...
        if(registerRuntimeOnly) {
            CacheContainerMetricsHandler.INSTANCE.registerMetrics(container);
        }
        ...
        if(registerRuntimeOnly) {
           CacheMetricsHandler.INSTANCE.registerCommonMetrics(local);
        }
        ...
        if(registerRuntimeOnly) {
           CacheMetricsHandler.INSTANCE.registerCommonMetrics(invalidation);
           CacheMetricsHandler.INSTANCE.registerClusteredMetrics(invalidation);
        }
        ...
        if(registerRuntimeOnly) {
           CacheMetricsHandler.INSTANCE.registerCommonMetrics(replicated);
           CacheMetricsHandler.INSTANCE.registerClusteredMetrics(replicated);
        }
        ...
        if(registerRuntimeOnly) {
           CacheMetricsHandler.INSTANCE.registerCommonMetrics(distributed);
           CacheMetricsHandler.INSTANCE.registerClusteredMetrics(distributed);
        }
    }
