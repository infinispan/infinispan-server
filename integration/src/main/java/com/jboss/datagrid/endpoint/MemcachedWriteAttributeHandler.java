...
public class MemcachedWriteAttributeHandler extends ReloadRequiredWriteAttributeHandler {
   ...
   static final MemcachedWriteAttributeHandler INSTANCE = new MemcachedWriteAttributeHandler();

   private MemcachedWriteAttributeHandler() {
       super(ATTRIBUTES);
   }
